...
I'll chase the updated statement and get back to you as soon as I have it.`,
  ...
  await db.insert(notifications).values([
    ...
    },
    {
      ...
      body: `${appRejected.referenceNumber} — Ngozi Obi was declined by credit review`,
    ...
    },
    {
      userId: md.id,
      type: 'loan_activity',
      title: 'High-value application declined',
      body: `${appRejected.referenceNumber} — Ngozi Obi (₦800,000) was declined by credit review`,
