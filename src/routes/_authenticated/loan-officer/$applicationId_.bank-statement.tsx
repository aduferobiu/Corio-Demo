...
export const Route = createFileRoute('/_authenticated/loan-officer/$applicationId_/bank-statement')({
  loader: ({ params }) => getApplicationFn({ data: { id: params.applicationId } }),
  component: LoanOfficerBankStatement,
})

function LoanOfficerBankStatement() {
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-white px-8 py-6">
          <button
            type="button"
            onClick={() => navigate({ to: '/loan-officer/$applicationId', params: { applicationId } })}
